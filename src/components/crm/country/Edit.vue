<template>
  <div class="form-country-detail form-detail">
    <panel>
      <h1 slot="header">更新国家</h1>
      <vform id="country-update-form" :actions="actions" :actionUrls="actionUrls"></vform>
    </panel>
  </div>
</template>
    ...
    data () {
      return {
        actionUrls: {
          ...
          saveUrl: commonUrls.country.update,
          afterSaveUrl: commonUrls.vuerouter.country.list
        },
        actions: {
