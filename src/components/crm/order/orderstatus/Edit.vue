<template>
  <div class="form-orderstatus-detail form-detail">
    <panel>
      <h1 slot="header">更新订单状态标准</h1>
      <vform id="orderstatus-update-form" :actions="actions" :actionUrls="actionUrls"></vform>
    </panel>
  </div>
</template>
    ...
    data () {
      return {
        actionUrls: {
          ...
          saveUrl: commonUrls.orderStatus.update,
          afterSaveUrl: commonUrls.vuerouter.orderStatus.list
        },
        actions: {
