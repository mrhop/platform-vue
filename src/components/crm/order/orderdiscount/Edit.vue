<template>
  <div class="form-orderdiscount-detail form-detail">
    <panel>
      <h1 slot="header">更新订单折扣标准</h1>
      <vform id="orderdiscount-update-form" :actions="actions" :actionUrls="actionUrls"></vform>
    </panel>
  </div>
</template>
    ...
    data () {
      return {
        actionUrls: {
          ...
          saveUrl: commonUrls.orderDiscount.update,
