<template>
  <div class="form-clientTrack-detail form-detail">
    <panel>
      <h1 slot="header">更新客户追踪</h1>
      <vform id="clientTrack-update-form" :actions="actions" :actionUrls="actionUrls"></vform>
    </panel>
  </div>
</template>
    ...
    data () {
      return {
        actionUrls: {
          ...
          saveUrl: commonUrls.clientTrack.update
        },
        actions: {
              ...
              let rules = {
                'items': [
                  ...
                  },
                  {
                    ...
                    defaultValue: response.data.trackMethod,
                    items: [
                      {
                        label: '电话',
                        value: 'phone'
                  ...
                  },
                  {
                    ...
                    defaultValue: response.data.duration,
                    items: [
                      {
                        label: '10分钟内',
                        value: 0
                  ...
                  },
                  {
                    ...
                    defaultValue: response.data.result,
                    items: [
                      {
                        label: '无法沟通',
                        value: -3
