...
<script>
  ...
  let articleSaveConfig = {
    url: commonUrls.article.save,
    method: 'post'
  }
        ...
        actions: {
          init: function (params) {
            axios.request(ruleChangeConfig).then(function (responseInner) {
              ...
              global.store.commit('FORM_FAILURE', {id: 'article-add-form', error})
            })
          },
          ...
          save: function (params) {
            ...
            articleSaveConfig.data = params.data
            axios.request(articleSaveConfig).then(function (response) {
              global.store.commit('FORM_SAVE_SUCCESS', {
                id: 'article-add-form',
                data: {}
              })
            }).catch(function (error) {
              global.store.commit('FORM_SAVE_FAILURE', {id: 'article-add-form', error})
            })
          }.bind(this)
        },
        blockListActions: {
